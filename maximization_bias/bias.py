...
class Bias():
    def __init__(self, n_iter = 1000, n_episodes = 100):
    ...
    def update_q(self, state_old, action, reward, state_new, alpha, e):
        ...
        if self.policy == 'WSQL': # WSQL with weight = 0.1
        ...
        for j in range(self.n_iter):
            ...
            for e in range(self.n_episodes):
                ...
                while not done:
                    ...
                    rw = rw + reward
                    # Update Q-Table
                    self.update_q(current_state, action, reward, newState, alpha, e)
